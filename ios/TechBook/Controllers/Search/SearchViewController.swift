...
class SearchViewController: UIViewController {
    ...
    var sectorId: String?
    let sectionTitles = ["SECTORS","PUBLICATIONS"]
    ...
    override func viewDidLoad() {
        ...
        // placeholder of searchBar
        self.searchBar.placeholder = "Enter title of publication here ..."
        // prepare nibCell of TableView of publication details
    ...
    // hide keybord on scroll
    func scrollViewWillBeginDragging(_ scrollView: UIScrollView) {
        self.searchBar.endEditing(true)
    }
    
    // hide keybord on clik btn return cliked
